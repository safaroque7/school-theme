...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
      array(
        'id'          => 'backgrouncolor',
        'title'       => __( 'থিমের কালার পরিবর্তন করা যাবে এখান থেকে...', 'theme-text-domain' )
      ),array(
        'id'          => 'body_backgrouncolor',
        'title'       => __( 'বডির ব্যাকগ্রাউন্ড কালার পরিবর্তন করা যাবে এখান থেকে...', 'theme-text-domain')
      ),array(
        'id'          => 'hover_color',
        'title'       => __( 'মেনুর অ্যাক্টিভ কালার ...', 'theme-text-domain')
      ),array(
        'id'          => 'menu_border_left',
        ...
        'id'          => 'notice_color',
        'title'       => __( 'নোটিশ ও নিউজ ইভেন্টের শিরোনামের কালার', 'theme-text-domain')
      ),array(
        'id'          => 'head_setting',
        'title'       => __( 'লোগো ও স্কুল/কলেজের নাম পরিবর্তন করা যাবে এখান থেকে', 'theme-text-domain' )
      ),
     array(
        'id'          => 'footer_setting',
        'title'       => __( 'যোগাযোগের ঠিকানা পরিবর্তন করা যাবে এখান থেকে', 'theme-text-domain' )
      ),
     array(
        'id'          => 'sit_setting',
        'title'       => __( 'বিভিন্ন শ্রেণীর আসন সংখ্যা', 'theme-text-domain' )
      )
    ),
    'settings'        => array( 
        array(
            'std'       =>  '#0091a2',
            'id'        =>  'backgrouncolor_id',
            'label'     =>  'এখান থেকে বডির ব্যাকগ্রাউন্ড কালার পরিবর্তন করা যাবে...',
            'desc'      =>  'এখান থেকে বডির ব্যাকগ্রাউন্ড কালার পরিবর্তন করা যাবে...',
            'type'      =>  'colorpicker',
            'section'  =>  'backgrouncolor',
        ),array(
            'id'        =>  'body_backgrouncolor_id',
            'label'     =>  'এখান থেকে থিমের কালার পরিবর্তন করা যাবে...',
            'desc'      =>  'এখান থেকে থিমের কালার পরিবর্তন করা যাবে...',
            'type'      =>  'colorpicker',
            'section'  =>  'body_backgrouncolor',
        ),array(
            'id'        =>  'hover_color_id',
            'label'     =>  'মেনু বাটনের হভার কালার সিলেক্ট করুন এখান থেকে...',
            'desc'      =>  'মেনু বাটনের হভার কালার সিলেক্ট করুন এখান থেকে...',
            'type'      =>  'colorpicker',
            'section'  =>  'hover_color',
        ),array(
            'std'       =>  '#05abbe',
            'id'        =>  'menu_border_left_id',
            'label'     =>  'মেনুর বামপাশের বর্ডারের কালার পছন্দ করুন এখান থেকে...',
            'desc'      =>  'মেনুর বামপাশের বর্ডারের কালার পছন্দ করুন এখান থেকে...',
            'type'      =>  'colorpicker',
            'section'   =>  'menu_border_left'
        ),array(
            'id'        =>  'menu_border_right_id',
            'label'     =>  'মেনুর ডানপাশের বর্ডারের কালার পছন্দ করুন এখান থেকে...',
            'desc'      =>  'মেনুর ডানপাশের বর্ডারের কালার পছন্দ করুন এখান থেকে...',
            'type'      =>  'colorpicker',
            'section'   =>  'menu_border_right',
            'std'       =>  '#037683'
        ),array(
            'id'        =>  'notice_color_id',
            'label'     =>  'নোটিশ ও নিউজ ইভেন্টের শিরোনামের কালার পরিবর্তন করতে পারবেন এখান থেকে',
            'desc'      =>  'নোটিশ ও নিউজ ইভেন্টের শিরোনামের কালার পরিবর্তন করতে পারবেন এখান থেকে',
            'type'      =>  'colorpicker',
            'section'  =>   'notice_color',
        ),array(
            'id'        =>  'logo',
            'label'     =>  'এখান থেকে মূল লোগোটি পুনরায় আপলোড/ডিলিট করা যাবে...',
            'desc'      =>  'আপনি প্রয়োজন মনে করলে এখান থেকে মূল লোগেটি পরিবর্তন করে নিতে পারেন। প্রস্থ ৬৫ পিক্সেল ও উচ্চতা ৮৫ পিক্সেল ব্যবহার করতে পারেন...',
            'type'      =>  'upload',
            'section'  =>  'head_setting',
        ),
        array(
            'id'        =>  'institue_name',
            'label'     =>  'এখান থেকে স্কুল/কলেজ/বিশ্ববিদ্যালয়ের নাম সম্পাদনা করা যাবে...',
            'desc'      =>  'এখান থেকে স্কুল/কলেজ/বিশ্ববিদ্যালয়ের নাম সম্পাদনা করা যাবে...',
            'type'      =>  'text',
            'section'  =>  'head_setting',
        ),
        array(
            'id'        =>  'eeiiin_number_and_address',
            'label'     =>  'স্থাপিত কত সালে EIIN নাম্বার কত এবং Inst. Number নাম্বার, ঠিকানা, ফোন ও ই-মেইল এখানে দেওয়া যাবে...',
            'desc'      =>  'স্থাপিত কত সালে EIIN নাম্বার কত এবং Inst. Number নাম্বার, ঠিকানা, ফোন ও ই-মেইল এখানে দেওয়া যাবে...',
            'type'      =>  'textarea',
            'section'  =>  'head_setting',
        ),
        array(
            'id'        =>  'address_id',
            'label'     =>  'এখান থেকে স্কুল/কলেজ/বিশ্ববিদ্যালয়ের ঠিকানা সম্পাদনা করা যাবে...',
            'desc'      =>  'এখান থেকে স্কুল/কলেজ/বিশ্ববিদ্যালয়ের ঠিকানা সম্পাদনা করা যাবে...',
            'type'      =>  'Textarea',
            'section'  =>  'footer_setting',
        ),
        array(
            'id'        =>  'class6_id',
            'label'     =>  '৬ষ্ঠ শ্রেণীর আসন সংখ্যা ও ভর্তিকৃত শিক্ষার্থীর সংখ্যা (বাংলা ইউনিকোড) লিখুন এখানে...',
            'desc'      =>  'এখান থেকে ৬ষ্ঠ শ্রেণীর আসন সংখ্যা ও ভর্তিকৃত শিক্ষার্থীর সংখ্যা সম্পাদনা করা যাবে...',
            'type'      =>  'text',
            'section'  =>  'sit_setting',
        ),
        array(
            'id'        =>  'class7_id',
            'label'     =>  '৭ম শ্রেণীর আসন সংখ্যা ও ভর্তিকৃত শিক্ষার্থীর সংখ্যা (বাংলা ইউনিকোড) লিখুন এখানে...',
            'desc'      =>  'এখান থেকে ৭ম শ্রেণীর আসন সংখ্যা ও ভর্তিকৃত শিক্ষার্থীর সংখ্যা সম্পাদনা করা যাবে...',
            'type'      =>  'text',
            'section'  =>  'sit_setting',
        ),
        array(
            'id'        =>  'class8_id',
            'label'     =>  '৮ম শ্রেণীর আসন সংখ্যা ও ভর্তিকৃত শিক্ষার্থীর সংখ্যা (বাংলা ইউনিকোড) লিখুন এখানে...',
            'desc'      =>  'এখান থেকে ৮ম শ্রেণীর আসন সংখ্যা ও ভর্তিকৃত শিক্ষার্থীর সংখ্যা সম্পাদনা করা যাবে...',
            'type'      =>  'text',
            'section'  =>  'sit_setting',
        ),
        array(
            'id'        =>  'class9_id',
            'label'     =>  '৯ম শ্রেণীর আসন সংখ্যা (বাংলা ইউনিকোড) লিখুন এখানে...',
            'desc'      =>  'এখান থেকে ৯ম শ্রেণীর আসন সংখ্যা ও ভর্তিকৃত শিক্ষার্থীর সংখ্যা সম্পাদনা করা যাবে...',
            'type'      =>  'text',
            'section'  =>  'sit_setting',
        ),
        array(
            'id'        =>  'class10_id',
            'label'     =>  '১০ম শ্রেণীর আসন সংখ্যা (বাংলা ইউনিকোড) লিখুন এখানে...',
            'desc'      =>  'এখান থেকে ১০ম শ্রেণীর আসন সংখ্যা ও ভর্তিকৃত শিক্ষার্থীর সংখ্যা সম্পাদনা করা যাবে...',
            'type'      =>  'text',
            'section'  =>  'sit_setting',
        ),
      array(
