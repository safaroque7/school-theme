            ...
            <form action="" method="GET">
                ...
                <div class="select_option">
                    ...
                    <select name="className" id="" required>
                        ...
                        <option id="class6" value="৬ষ্ঠ"> ৬ষ্ঠ শ্রেণী </option>
                        <option id="class7" value="৭ম"> ৭ম শ্রেণী </option>
                        <option id="class8" value="৮ম"> ৮ম শ্রেণী </option>
                        <option id="class9" value="৯ম"> ৯ম শ্রেণী </option>
                        <option id="class10" value="১০ম"> ১০ম শ্রেণী </option>
                    </select>
                </div>
                <!--.end select_option-->
                ...
                <!--start select_option-->
                <div class="select_option jq_section_name">
                    <select name="sectionName" id="section_name_6_8" required>
                        <option selected="selected" disabled="disabled">
                            -- শাখা --
                        </option>
                        ...
                        <option value="প্রভাতী"> প্রভাতী </option>
                        <option value="দিবা"> দিবা </option>
                    </select>
                </div>
                <!--.end select_option-->
                ...
                <!--start select_option-->
                <div class="select_option jq_division_name">
                    <select name="divisionName" id="divisionName_6_8" required>
                        <option selected="selected" disabled="disabled">
                            -- বিভাগ --
                        </option>
                ...
                <!--start select_option-->
                <div class="select_option">
                    <select name="result_type" id="" required>
                        <option selected="selected" disabled="disabled">
                            -- পরীক্ষার ধরণ --
                        </option>
                ...
                <div class="rollNumberSection">
                    <input type="text" name="rollNumber" placeholder="Roll Number(Numeric)" id="" required>
                </div>
                <!--.end select_option-->
                        ...
                        'relation' => 'AND',
                            ...
                            array(
                                'relation'  =>  'OR',
                                    array(
                                        'key'     => 'sectionName',
                                        'value'   => $_GET['sectionName'],
                                    ),
                                    array(
                                        'key'     => 'oneGroup',
                                        'value'   => $_GET['divisionName'],
                                    )
                ...
                <?php while( $d_r_query->have_posts() ) : $d_r_query->the_post(); ?>
                    ...
                    <div class="dynamic_result amader_kotha result fix">
                        <div class="fix d_r_part">
                            <h3> 
                                <b class="d_r_title"> শিক্ষার্থীর নাম &nbsp; : </b> <?php the_title();?>  
                            </h3>
                            <h3><b class="d_r_title"> পিতার নাম &nbsp; : </b> 
                                <span class="d_r_distance"> 
                                    <?php the_field('father_name');?> </span>  
                            </h3>
                            <h3><b class="d_r_title"> মাতার নাম &nbsp; : </b> 
                                <span class="d_r_distance"> 
                                    <?php the_field('mother_name');?> </span>  
                           </h3>
                            <h3><b class="d_r_title"> জন্ম তারিখ &nbsp; : </b> 
                                <?php the_field('birth_date');?> 
                            </h3>
                            <h3> <b class="d_r_title"> শ্রেণী &nbsp; : </b> 
                                <?php the_field('class_for_result');?> 
                            </h3>
                            <h3> <b class="d_r_title"> সাল &nbsp; : </b> 
                                <?php the_field('result_year');?> 
                            </h3>
                            <h3> <b class="d_r_title"> রোল নং &nbsp; : </b> 
                                <?php the_field('roolNo');?> 
                            </h3>

                            <?php $sectionName = get_post_meta(get_the_id(), "sectionName", true);?>
                                <?php if(!empty($sectionName)){?>
                                    <h3> <b class="d_r_title"> শাখা &nbsp; : </b> 
                                        <?php echo $sectionName;?> </h3>
                                <?php } ?>
                                
                                <?php $oneGroup = get_post_meta(get_the_id(), "oneGroup", true);?>
                                    <?php if(!empty($oneGroup)){?>
                                        <h3> <b class="d_r_title"> বিভাগ &nbsp; : </b> 
                                               <?php the_field('oneGroup');?> 
                                        </h3>
                                    <?php } ?>

                                    <?php $type_of_result = get_post_meta(get_the_id(), "type_of_result", true);?>
                                    <?php if(!empty($type_of_result)){?>
                                    <h3> <b class="d_r_title"> পরীক্ষার ধরণ &nbsp; : </b> 
                                        <?php echo $type_of_result;?> </h3>
                                <?php } ?>
                ...
                <?php $className = get_post_meta(get_the_id(), "class_for_result", true);?>
                    ...
                    <div class="fix optional_subject">
                        <div class="fix optional_subject_title"><b> ঐচ্ছিক বিষয় </b></div>
                            ...
                            <?php $oneGroup_name = get_post_meta(get_the_id(), "oneGroup", true);?>
                                <?php if($oneGroup_name == 'বিজ্ঞান' || $oneGroup_name == 'বাণিজ্য' || 
                                         $oneGroup_name == 'মানবিক'){?>
                            ...
                            <?php } ?>                     
                                    ...
                                    <div class="without_optional_result_title">
                                       ...
                                       <?php if($b_h_a_e_grade_result>2){?> 
                                            ...
                                            <?php } else { ?>
                                                <p> ঐচ্ছিক নাম্বার 2 এর চেয়ে কম হওয়ায় যোগ হয়নি </p>
                                        <?php }?>    
                                    </div>
                                    <!--.end without_optional_result-->
                        ...
                        <!---------- ৯ম-১০ম শ্রেণীর বিজ্ঞান বিভাগের ফলাফল ---------->
                                                    ...
                                                    <?php $class_for_pass_fail = get_post_meta(get_the_id(), "class_for_result", true);?>
                                                        <?php $group_for_pass_fail = get_post_meta(get_the_id(), "oneGroup", true);?>
                                                            ...
                                                            <?php if($class_for_pass_fail == '৯ম' && $group_for_pass_fail == 'বিজ্ঞান' || 
                     $class_for_pass_fail == '১০ম' && $group_for_pass_fail == 'বিজ্ঞান' ){?>
                                                                ...
                                                                <?php } ?>
                                                                    ...
                                                                    <?php $class_for_pass_fail = get_post_meta(get_the_id(), "class_for_result", true);?>
                                                                        <?php $group_for_pass_fail = get_post_meta(get_the_id(), "oneGroup", true);?>
                                                                            ...
                                                                            <?php if($class_for_pass_fail == '৯ম' && $group_for_pass_fail == 'বাণিজ্য'  || 
                     $class_for_pass_fail == '১০ম' && $group_for_pass_fail == 'বাণিজ্য' ){?>
                                                                                ...
                                                                                <?php } ?>
                                                                                    ...
                                                                                    <?php $class_for_pass_fail = get_post_meta(get_the_id(), "class_for_result", true);?>
                                                                                        <?php $group_for_pass_fail = get_post_meta(get_the_id(), "oneGroup", true);?>
                                                                                            ...
                                                                                            <?php if($class_for_pass_fail == '৯ম' && $group_for_pass_fail == 'মানবিক' || 
                     $class_for_pass_fail == '১০ম' && $group_for_pass_fail == 'মানবিক' ){?>
    ...
    <!--.end result_sheet_per_subject-->
        ...
        <?php } ?>
            ...
            <div class="clear"></div>
                    ...
                    শ্রেণী, সাল, ফলাফলের ধরণ নির্বাচন ও সঠিক রোল নাম্বার দিয়ে অনুসন্ধান করুন...ধন্যবাদ
                </span>
                        <?php endif; ?>
                            <?php wp_reset_query(); ?>
