<?php 
/*
    Template Name: সভাপতিগণের তালিকা
*/
get_header();?>
        
        <?php            
            query_posts('post_type=presidentlist&post_status=publish&order=desc&posts_per_page=10&paged='
            .get_query_var('paged'));
        ?>
        <div class="maincontent fix">
            ...
            <div class="amader_kotha fix">
                <h2 style='color:
                    ...
                    <?php echo ot_get_option( 'backgrouncolor_id');?>'> 
                    বিদ্যালয়ের শুরু থেকে অদ্যবধি সভাপতিগণের তালিকা  
                </h2>                  
                    ...
                    <div class="fix box_for_border">
                        <div class="fix donation">
                            ...
                            <div class="donation_amount fix"><h2> অর্জন </h2></div>
                        </div>    
                        ...
                        <?php while(have_posts()):the_post();?>
                            <div class="fix donation">
                                <div class="donation_roll fix"> <h4> <?php the_field('roll');?> </h4></div>
                                 ...
                                 <div class="donation_amount fix"><h4> <?php the_field('achievement');?> </h4></div>
                            </div> 
                        <?php endwhile;?>
                    ...
                    <div class="pagination_for_1000_and_750px">
                            <?php get_template_part('part/pagination_for_president_list');?>
                    </div>
                            ...
                            <div class="fix donation">
                                <div class="donation_roll fix"> 
                                 ...
                                 <div class="donation_amount fix">
                                     <h4> <b> অর্জন : </b> <?php the_field('achievement');?> </h4></div>
                            </div> 
                        <?php endwhile;?>   
                    </div>  <!--end box_for_border -->
                    <div class="pagination_for_300px">
                        <?php get_template_part('part/donation_pagination');?>
                    </div> 
            </div>
<?php get_footer();?>