<?php
/*
    Template Name: আজীবন দাতা সদস্য
*/
get_header();?>
        
        <?php            
            query_posts('post_type=donation&post_status=publish&order=asc&posts_per_page=10&paged='
            .get_query_var('paged'));
        ?>
        ...
        <div class="maincontent fix">
            <div class="amader_kotha fix">
                ...
                <h2 style='color:
                           ...
                           <?php echo ot_get_option( 'backgrouncolor_id');?>'> 
                           বিদ্যালয়ের উন্নয়নে আজীবন দাতা সদস্যগণ 
                </h2>                
            ...
            <div class="fix box_for_border">
                <div class="fix donation">
                    ...
                    <div class="donation_amount fix">
                        <h2> দানকৃত বিষয়/আর্থিক পরিমাণ </h2>
                    </div>
                </div>
                <?php while(have_posts()):the_post();?>
                    <div class="fix donation">
                        <div class="donation_roll fix"> <h4> <?php the_field('roll');?> </h4></div>
                         ...
                         <div class="donation_amount fix"><h4> <?php the_field('quantity');?> </h4></div>
                    </div> 
                <?php endwhile;?>   
                ...
                <?php while(have_posts()):the_post();?>
                    <div class="fix donation">
                        <div class="donation_roll fix"> 
                         ...
                         <div class="donation_duration fix">
                             <h4> <b> সময়কাল : </b> <?php the_field('time');?></h4></div>
                         <div class="donation_amount fix">
                             <h4> <b> দানকৃত বিষয়/আর্থিক পরিমাণ : </b> <?php the_field('quantity');?> </h4></div>
                    </div> 
                <?php endwhile;?>   
            </div>  <!--end box_for_border -->
